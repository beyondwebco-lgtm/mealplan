...
export const ToastContainer: React.FC<ToastProps> = ({ toasts, onDismiss }) => {
  ...
  return (
    <div className="fixed bottom-16 sm:bottom-5 left-4 right-4 sm:left-auto sm:right-5 z-50 flex flex-col gap-2 max-w-sm pointer-events-none mx-auto sm:mx-0">
      {toasts.map((toast) => {
